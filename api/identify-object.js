...
// Este handler agora responde ao endpoint /api/identify-object
export default async function handler(request, response) {
    try {
        ...
        // --- NOVO PROMPT: IDENTIFICADOR UNIVERSAL DE PRODUTOS ---
        let promptText = `
        ...
        O usuário forneceu o seguinte CONTEXTO (use isso como dica):
        ...
        {
          "identification": {
            "name": "Nome exato do produto (inclua Marca e Modelo, se visível. Ex: 'Tênis Nike Air Force 1 07 Branco', 'Caneca de cerâmica azul', 'iPhone 15 Pro Max Titânio Natural')",
